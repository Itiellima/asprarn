...
@section('content')
    ...
    <div class="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
        <div class="col-lg-6 px-0">
            <h1 class="display-4 fst-italic">ASPRA de cara nova, fique por dentro de todas as novidades.</h1>
        ...
        <div class="col-md-4">
            <div class="position-sticky" style="top: 6rem;">
                <div class="p-4 mb-3 bg-body-tertiary rounded">
                    <h4 class="fst-italic">Sobre a ASPRA</h4>
                ...
                <div class="p-4">
                    ...
                    <ol class="list-unstyled">
                        ...
                        <li><a href="https://www.instagram.com/associacaosdospracas/" target="_blank">Instagram</a></li>
                    </ol>
                </div>
            </div>
        </div>
